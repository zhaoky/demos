...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/entry/entry-server.js");
/******/ })
/************************************************************************/
/******/ ({
...
var debug = __webpack_require__(/*! debug */ "./node_modules/follow-redirects/node_modules/debug/src/index.js")("follow-redirects"); // RFC7231§4.2.1: Of the request methods defined by this specification,
...
const data = {
  list: () => axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('http://rap2.taobao.org:38080/app/mock/254238/get//api/ele?type=1').then(res => {
    return res.data;
  }).catch(err => {
...
function createApp() {
  const router = Object(_router_router__WEBPACK_IMPORTED_MODULE_1__["createRouter"])();
  const store = Object(_store_store__WEBPACK_IMPORTED_MODULE_2__["createStore"])();
  Object(vuex_router_sync__WEBPACK_IMPORTED_MODULE_3__["sync"])(store, router);
...
/* harmony default export */ __webpack_exports__["default"] = (context => {
  return new Promise((resolve, reject) => {
    const {
      ...
      router,
      store
    } = Object(_app__WEBPACK_IMPORTED_MODULE_0__["createApp"])();
...
const Foo = () => __webpack_require__.e(/*! import() */ 2).then(__webpack_require__.bind(null, /*! ../components/foo.vue */ "./src/components/foo.vue"));

const Bar = () => __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.bind(null, /*! ../components/bar.vue */ "./src/components/bar.vue"));

const NoFound = () => __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ../components/404.vue */ "./src/components/404.vue"));
  ...
  return new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
    ...
    actions: {
      async fetchList({
        ...
        let list = await _api_index__WEBPACK_IMPORTED_MODULE_2__["data"].list();
