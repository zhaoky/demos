...
/******/ 		return __webpack_require__.p + "" + chunkId + ".bundle-client.js"
/******/ 	}
/******/
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/entry/entry-client.js");
/******/ })
/************************************************************************/
/******/ ({
...
router.onReady(() => {
  app.$mount('#app'); // 客户端数据预取（非首屏渲染的情况），也可以将此逻辑放到对应视图组件的 beforeMount 里执行。
